...
if (isset($_GET['publish']) || isset($_GET['unpublish'])) 	//get button status
{
$message = "";
if (isset($_GET['publish'])) {
	$message = "Post published successfully";
	$post_id = $_GET['publish'];							//get post id
} else if (isset($_GET['unpublish'])) {
	$message = "Post successfully unpublished";				//get post id
	$post_id = $_GET['unpublish'];
}
togglePublishPost($post_id, $message);						//call publish function
}
